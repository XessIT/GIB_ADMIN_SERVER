...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($video["tmp_name"], $videoPath)) {
        ...
        if ($thumbnailPath) {
            $sql = "INSERT INTO gibachievementvideos (event_name, videos_name, videos_path, thumbnail_path, selectedDate) VALUES ('$eventName', '{$video["name"]}', '$videoPath', '$thumbnailPath', '$selectedDate')";
