...
class DoctorsWing extends StatelessWidget {
  const DoctorsWing({Key? key}) : super(key: key);
...
class DoctorWingPage extends StatefulWidget {
  const DoctorWingPage({Key? key}) : super(key: key);

  @override
  State<DoctorWingPage> createState() => _DoctorWingPageState();
}

class _DoctorWingPageState extends State<DoctorWingPage> {
...
class _ShowAllPageState extends State<ShowAllPage> {
  ...
  countDocuments() async {
    ...
    await FirebaseFirestore.instance.collection('Register').where("Member Type", isEqualTo:doctor).get();
    ...
    return   Scaffold(
      body: Form(
        ...
        where("District",isEqualTo:selecteddistrict)
                    ...
                    .where("Member Type",isEqualTo: doctor)
