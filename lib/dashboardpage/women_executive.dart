...
class WExecutive extends StatelessWidget {
  const WExecutive({Key? key}) : super(key: key);
...
class WExecutivePage extends StatefulWidget {
  const WExecutivePage({Key? key}) : super(key: key);

  @override
  State<WExecutivePage> createState() => _WExecutivePageState();
}

class _WExecutivePageState extends State<WExecutivePage> {
                          ...
                          children: [
                            const TabBar(
                              //  controller: _tabController,
                                ...
                                tabs: [
                                  Tab(text: ("Women's Executive Wing"),),
...
class _ShowAllPageState extends State<ShowAllPage> {
  ...
  String Wwing="Executive Women's Wing";
  ...
  countDocuments() async {
    ...
    await FirebaseFirestore.instance.collection('Register').where("Member Type", isEqualTo:Wwing).get();
            ...
            Column(
              children: [
                StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance.collection("Register")
                        .where("Member Type", isEqualTo: Wwing)
