...
class ExeMember extends StatelessWidget {
  const ExeMember({Key? key}) : super(key: key);
...
class ExeMemberPage extends StatefulWidget {
  const ExeMemberPage({Key? key}) : super(key: key);

  @override
  State<ExeMemberPage> createState() => _ExeMemberPageState();
}

class _ExeMemberPageState extends State<ExeMemberPage> {
...
class _ShowAllPageState extends State<ShowAllPage> {
  ...
  countDocuments() async {
    ...
    await FirebaseFirestore.instance.collection('Register').where("Member Type", isNotEqualTo:exemem).get();
                                ...
                                child: Table(
                                    ...
                                    children:[
                                      ...
                                      for(var i = 0 ;i < storedocs.length; i++) ...[
                                        if (storedocs[i]["First Name"].toString().toLowerCase().startsWith(name!.toLowerCase())||storedocs[i]["Company Name"].toString().toLowerCase().startsWith(name!.toLowerCase()))
